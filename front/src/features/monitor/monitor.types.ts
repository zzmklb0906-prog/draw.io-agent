export interface MonitorSummary { total: number; success: number; errors: number; active: number; averageDurationMs: number; inputTokens: number; outputTokens: number; totalTokens: number; registeredTools: string[]; registeredCapabilities?: number }
